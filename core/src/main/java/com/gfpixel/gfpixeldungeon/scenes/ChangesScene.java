...
public class ChangesScene extends PixelScene {
	...
	public void create() {
        ...
        ChangeInfo changes = new ChangeInfo("v0.50B", true, "加入新武器");
        changes.hardlight(Window.TITLE_COLOR);
        infos.add(changes);

        changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.type561, null), new type561().trueName(),
				"-该冲锋枪相较于AK47射程更远，但伤害低\n\n" + "-随着武器的强化，威力将大大增强"));

        changes.addButton(new ChangeButton(new ItemSprite(ItemSpriteSheet.type562, null), new type562().trueName(),
                "-该冲锋枪是56-1式冲锋枪的改进型号，攻击距离、伤害、精度得到了提高，且具备榴弹发射的能力\n\n" + "-随着武器的强化，威力将大大增强"));
        ...
        changes.addButton(new ChangeButton(new Negev(),
                "_-_ 무기 조정.\n\n" +
                        ...
                        "_-_ C96으로 타격시 10턴 동안 발광 버프를 받게 됩니다.\n\n" +
