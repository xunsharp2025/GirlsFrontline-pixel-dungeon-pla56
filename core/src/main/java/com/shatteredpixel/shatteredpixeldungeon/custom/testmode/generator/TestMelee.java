...
public class TestMelee extends TestGenerator {
    ...
    private Class<? extends Weapon>[] weaponList(int t) {
        switch (t) {
            ...
            case 6:
                return (Class<? extends Weapon>[]) Generator.Category.WEP_T6.classes.clone();
        }
    }
    ...
    private class SettingsWindow extends Window {
        ...
        private void layout() {
            o_tier.setRect(0, GAP, WIDTH, 24);
            //createWeaponImage(all);
            t_selectedWeapon.setPos(0, GAP * 2 + o_tier.bottom()+20 + BTN_SIZE);
            o_level.setRect(0, t_selectedWeapon.bottom()+10 + GAP, WIDTH, 24);
