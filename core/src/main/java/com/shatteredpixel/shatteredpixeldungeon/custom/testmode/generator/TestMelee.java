...
public class TestMelee extends TestItem {
    {
    ...
    private class WeaponSetting extends Window {
        ...
        public WeaponSetting() {
            ...
            Button_Level = new RedButton(Messages.get(this, "select_weapon")) {
                @Override
                protected void onClick() {
                    if(!Button_Level.text().equals(Messages.get(TestMelee.WeaponSetting.class, "select_weapon"))){ // 修改此行代码
                        Game.runOnRenderThread(() ->GameScene.show(new WndTextNumberInput(
                                Messages.get(TestMelee.WeaponSetting.class, "weapon_level"), Messages.get(TestMelee.WeaponSetting.class, "weapon_level_desc"),
                                Integer.toString(weapon_level),
                                4, false, Messages.get(TestMelee.WeaponSetting.class, "confirm"),
                                Messages.get(TestMelee.WeaponSetting.class, "cancel"),false) {
                            @Override
                        ...
                        Game.scene().add( new WndError( Messages.get(TestMelee.WeaponSetting.class, "weapon_level_error") ) );
                    }
                }
            };
