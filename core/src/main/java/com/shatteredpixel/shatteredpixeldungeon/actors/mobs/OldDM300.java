...
import com.shatteredpixel.shatteredpixeldungeon.sprites.OldDM300Sprite;
...
public class OldDM300 extends Mob {
    ...
    {
        spriteClass = OldDM300Sprite.class;
    ...
    public void magnum() {
        ...
        if (ch != null) {
            ch.damage(Math.max(damageRoll() - ch.drRoll(), 0), OldDM300.this );
    ...
    public int damageRoll() {
        return Random.NormalIntRange( 20, 20 );
    }
