...
public class RabbitLevel extends RegularLevel {
	...
	public String tileName( int tile ) {
		switch (tile) {
			case Terrain.WATER:
				return Messages.get(RabbitLevel.class, "water_name");
			default:
	...
	public String tileDesc(int tile) {
		switch (tile) {
			case Terrain.EMPTY_DECO:
				return Messages.get(RabbitLevel.class, "empty_deco_desc");
			case Terrain.BOOKSHELF:
				return Messages.get(RabbitLevel.class, "bookshelf_desc");
			default:
