...
public class WelcomeScene extends PixelScene {
	...
	private static int LATEST_UPDATE = GirlsFrontlinePixelDungeon.v0_6_5;
	...
	public void create() {
		...
		if (GirlsFrontlinePixelDungeon.versionCode == previousVersion) {
	...
	private void updateVersion(int previousVersion){
		...
		if (previousVersion <= GirlsFrontlinePixelDungeon.v0_6_0b){
