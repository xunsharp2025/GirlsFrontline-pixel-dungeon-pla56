...
public class v0_9_X_Changes {
	...
	public static void add_v0_9_2_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton( new ChangeButton( new Image(Assets.Sprites.WARRIOR, 0, 90, 22, 23), HeroSubClass.GLADIATOR.title(),
		...
		changes.addButton( new ChangeButton( new Image(Assets.Sprites.ROGUE, 0, 90, 22, 23), HeroSubClass.FREERUNNER.title(),
	...
	public static void add_v0_9_1_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(new Image(Assets.Sprites.HUNTRESS, 0, 15, 22, 23), "Huntress and Rogue Adjustments",
		...
		changes.addButton( new ChangeButton( new Image(Assets.Sprites.MAGE, 0, 90, 22, 23), HeroSubClass.BATTLEMAGE.title(),
	...
	public static void add_v0_9_0_Changes( ArrayList<ChangeInfo> changeInfos ) {
		...
		changes.addButton(new ChangeButton(new Image(Assets.Sprites.WARRIOR, 0, 15, 22, 23), "Hero balance adjustments",
