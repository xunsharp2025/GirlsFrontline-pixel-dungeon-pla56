...
public class LevelPlot_P5 extends Plot {
    ...
    private void process_to_1() {
        ...
        diagulewindow.setMainAvatar(Script.NPC_DISTROYER(1));
        diagulewindow.setLeftName(Script.Name(Script.Character.DESTROYER));
        diagulewindow.changeText(Messages.get(this, "dialog0"));
    }

    private void process_to_2() {
        diagulewindow.setMainAvatar(Script.NPC_DREAM(2));
        diagulewindow.setLeftName(Script.Name(Script.Character.DREAM));
    ...
    private void process_to_4() {
        diagulewindow.setMainAvatar(Script.NPC_DREAM(1));
        diagulewindow.setLeftName(Script.Name(Script.Character.DREAM));
    ...
    private void process_to_7() {
        diagulewindow.setMainAvatar(Script.NPC_DREAM(0));
        diagulewindow.setLeftName(Script.Name(Script.Character.DREAM));
        diagulewindow.changeText(Messages.get(this, "dialog6"));
    }

    private void process_to_8() {
        diagulewindow.setMainAvatar(Script.NPC_DISTROYER(0));
        diagulewindow.setLeftName(Script.Name(Script.Character.DESTROYER));
