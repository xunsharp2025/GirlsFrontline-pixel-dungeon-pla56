...
public class v0_3_X_Changes {
	...
	public static void add_v0_3_5_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new Image(Assets.Sprites.WARRIOR, 0, 15, 22, 23), "Warrior Rework!",
				"Warrior Rework:\n" +
		...
		changes.addButton( new ChangeButton(new Image(Assets.Sprites.WARRIOR, 0, 90, 22, 23), "Warrior Subclass Rework!",
				"Berserker Rework:\n" +
	...
	public static void add_v0_3_0_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new Image(Assets.Sprites.MAGE, 0, 15, 22, 23), "Mage Rework!",
