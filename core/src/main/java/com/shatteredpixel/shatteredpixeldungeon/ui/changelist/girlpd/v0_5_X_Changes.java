...
public class v0_5_X_Changes {
    ...
    public static void add_0_5_2_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton(new ChangeButton(new Image(Assets.Sprites.SPINNER, 144, 0, 16, 16), Messages.get(ChangesScene.class, "bugfixes"),
			"现在鼠王护甲能正常使用了，561也可以使用鼠王护甲\n"+
			"修改了铁匠贴图\n"+
			"更改了恶魔血巢的显示偏移，现在视觉上不会阻挡其他怪物了\n"+
			"修复了G11傀儡攻击崩溃bug\n"+
			"修复了骷髅文本错误问题\n"+
			"修复了vector冲锋枪buff未生效的问题\n"+
			"修复了元素风暴不能使用的问题\n"+
			"修复了法杖(子弹)鉴定时的文本\n"+
			"修复了部分文本问题\n"+
			"删除了G11，将其功能合并到magesstaff，修复了”法杖回收“天赋不能正常发挥作用的问题\n"+
			"调整了坠落音效的音量大小为原来的2/3\n"+
			"修复了G11的装弹强化天赋不能正常触发的bug，同时调小了死亡音效的音量\n"+
			"修复了561饭是钢天赋不能正常触发的问题\n"+
			"现在鼠王护甲能正常使用了，561也可以使用鼠王护甲了\n"+
			"修复了护卫者无限掉落血瓶的问题\n"
		));
	};
