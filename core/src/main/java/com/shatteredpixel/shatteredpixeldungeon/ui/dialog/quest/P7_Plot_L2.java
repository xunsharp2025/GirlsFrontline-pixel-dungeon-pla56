...
public class P7_Plot_L2 extends Plot {
    ...
    private void process_to_1() {
        ...
        diagulewindow.setMainAvatar(Script.NPC_P7(1));
        diagulewindow.setLeftName(Script.Name(Script.Character.P7));
    ...
    private void process_to_3() {
        diagulewindow.setMainAvatar(Script.NPC_P7(0));
        diagulewindow.setLeftName(Script.Name(Script.Character.P7));
