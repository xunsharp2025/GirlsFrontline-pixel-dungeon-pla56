...
public class v0_6_X_Changes {
	...
	public static void add_v0_6_5_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton(new Image(Assets.Sprites.WARRIOR, 0, 90, 22, 23), "Berserker",
		...
		changes.addButton( new ChangeButton(new Image(Assets.Sprites.MAGE, 0, 90, 22, 23), "Warlock",
		...
		changes.addButton( new ChangeButton( new Image(Assets.Sprites.HUNTRESS, 0, 15, 22, 23), "Huntress",
		...
		changes.addButton( new ChangeButton(new Image(Assets.Sprites.SKELETON, 0, 0, 22, 23), "Skeletons",
	...
	public static void add_v0_6_2_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( new Image(Assets.Sprites.ROGUE, 0, 15, 22, 23), "Rogue Rework!",
		...
		changes.addButton( new ChangeButton( new Image(Assets.Sprites.ROGUE, 0, 90, 22, 23), "Rogue Subclasses Rework!",
		...
		changes.addButton( new ChangeButton( new Image(Assets.Sprites.STATUE, 0, 0, 22, 23), "AI and Enemy Changes",
	...
	public static void add_v0_6_1_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( new Image(Assets.Sprites.STATUE, 0, 0, 22, 23), "AI Changes",
