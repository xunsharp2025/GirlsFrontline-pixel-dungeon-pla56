...
public class v0_7_X_Changes {
	...
	public static void add_v0_7_4_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( new Image(Assets.Sprites.MAGE, 0, 90, 22, 23), "Subclass Adjustments",
	...
	public static void add_v0_7_3_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( new Image(Assets.Sprites.WARRIOR, 0, 90, 22, 23), "Berserker & Gladiator",
		...
		changes.addButton( new ChangeButton( new Image(Assets.Sprites.WARRIOR, 0, 15, 22, 23), "Warrior Nerfs",
	...
	public static void add_v0_7_1_Changes( ArrayList<ChangeInfo> changeInfos ){
		...
		changes.addButton( new ChangeButton( new Image(Assets.Sprites.HUNTRESS, 0, 15, 22, 23), "Huntress Reworked!",
		...
		changes.addButton( new ChangeButton( new Image(Assets.Sprites.HUNTRESS, 0, 90, 22, 23), "Huntress Subclasses Reworked!",
		...
		changes.addButton( new ChangeButton( new Image(Assets.Sprites.ROGUE, 0, 15, 22, 23), "Hero Buffs",
